								...
								<ul>
									...
									foreach ($groups as $key => $group) {
										...
										<li>
											...
											<input id="acf_<?php echo $post_type . '_' . $group['ID'];?>" type="checkbox" name="acf[<?php echo $group['slug'];?>]" <?php if ( ! empty($post['acf'][$group['ID']]) || isset($group['slug']) && !empty($post['acf'][$group['slug']])): ?>checked="checked"<?php endif; ?> value="1" rel="<?php echo $group['ID'];?>" class="pmai_acf_group"/>
